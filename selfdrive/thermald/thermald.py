...
def thermald_thread():
  ...
  while 1:
    ...
    chargingDisabled = charging_disabled
    ...
    if chargingDisabled != charging_disabled:
      ...
      print( 'charging Status={}  current={} percent={}'.format( msg.thermal.batteryStatus, msg.thermal.batteryCurrent, msg.thermal.batteryPercent ) )
